...
public class PiezoMathCalculation
{
    ...
    /// <summary>
    /// Convert16to10s the specified value.
    /// </summary>
    ...
    /// <param name="count"></param>
    /// <returns></returns>
    public double[] getArrayFromStartEndCountVals(double start, double end, int count)
    {
